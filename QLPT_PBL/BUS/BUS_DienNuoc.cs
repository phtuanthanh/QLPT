...
namespace BUS
{
    public class BUS_DienNuoc
    {
        ...
        {
            return DAL_DienNuoc.Instance.GetDienNuocAll();
        }
        ...
        {
            return DAL_DienNuoc.Instance.GetDienNuocAllByTrangThai(tt);
        }
        ...
        {
            DAL_DienNuoc.Instance.InsertDienNuoc(id, sodien, sonuoc, dongiadien, dongianuoc);
        }
        #endregion
    }
}
