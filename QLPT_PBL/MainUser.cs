...
namespace QLPT_PBL
{
    public partial class MainUser : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            DTO_KhachHang kh = new DTO_KhachHang(id,name,this.user,this.pass,cmnd,phone,flag,diachi,false,maphong);

            bool a = BUS_KhachHang.Instance.Update(kh);
                ...
                else
                {
                    ...
                    else
                    {
                        if (MessageBox.Show("Bạn chắc chắn sẽ đổi mật khẩu ??", "Thông báo", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
                        {
                            ...
                            DTO_TaiKhoan tk = new DTO_TaiKhoan(id, newPass, ten, quyen, Flg, insetFlag);
                            BUS_TaiKhoan.Instance.Update(tk);
                            this.pass = pass;
                            DataInitThongTinKhachHang(this.user, this.pass);
